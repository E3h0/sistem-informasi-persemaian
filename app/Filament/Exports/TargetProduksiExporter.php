...
class TargetProduksiExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('target_produksi')->label('Target Produksi'),
            ExportColumn::make('sudah_diproduksi')->label('Sudah Diproduksi'),
            ExportColumn::make('sudah_distribusi')->label('Sudah Distribusi'),
            ExportColumn::make('stok_akhir')->label('Stok Akhir'),
    ...
    {
        $body = 'Proses eskpor target & realisasi produksi sudah selesai dan ' . number_format($export->successful_rows) . ' baris sudah diekspor.';
