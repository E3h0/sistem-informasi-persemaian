...
class PersediaanAlatKerjaExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('jumlah_dipakai')->label('Jumlah Dipakai'),
    ...
    {
        $body = 'Proses eskpor persediaan alat kerja sudah selesai dan ' . number_format($export->successful_rows) . ' baris sudah diekspor.';
