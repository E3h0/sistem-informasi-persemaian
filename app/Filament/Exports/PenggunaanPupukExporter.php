...
class PenggunaanPupukExporter extends Exporter
{
    ...
    {
        return [
            ExportColumn::make('pupuk.nama_pupuk')->label('Nama Pupuk'),
            ExportColumn::make('bentukPupuk.nama_bentuk')->label('Bentuk Pupuk'),
            ExportColumn::make('kategoriPupuk.nama_kategori')->label('Kategori Pupuk'),
            ExportColumn::make('jumlah_penggunaan')->label('Jumlah Penggunaan'),
            ExportColumn::make('satuanPupuk.nama_satuan')->label('Satuan Pupuk'),
    ...
    {
        $body = 'Proses eskpor penggunaan pupuk sudah selesai dan ' . number_format($export->successful_rows) . ' baris sudah diekspor.';
