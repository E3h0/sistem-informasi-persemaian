...
class PupukExporter extends Exporter
{
    ...
    {
        return [
            ExportColumn::make('nama_pupuk')->label('Nama Pupuk'),
    ...
    {
       $body = 'Proses eskpor Pupuk sudah selesai dan ' . number_format($export->successful_rows) . ' baris sudah diekspor.';
