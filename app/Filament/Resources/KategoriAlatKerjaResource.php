...
use App\Filament\Resources\KategoriAlatKerjaResource\Pages;
use App\Filament\Resources\KategoriAlatKerjaResource\RelationManagers;

class KategoriAlatKerjaResource extends Resource
{
    protected static ?string $model = KategoriAlatKerja::class;

    protected static ?string $modelLabel = "Kategori Alat Kerja";
    protected static ?string $pluralModelLabel = "Kategori Alat Kerja";
    protected static ?string $slug = "kategori-alat-kerja";
    protected static ?string $breadcrumb = "Kategori Alat Kerja";
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\EditAction::make()
                    ->modalHeading('Edit Data Kategori Alat Kerja')
                    ->form([
                 ...
                 Tables\Actions\DeleteAction::make()
                    ->action(function ($record){
                        if ($record->persediaan()->count() > 0) {
                            Notification::make()
                                ->danger()
                                ->title('Gagal, Tidak Dapat Menghapus')
                                ->body('Kategori alat kerja  ini sedang digunakan di data Persediaan Alat Kerja')
                                ->send();
                            return;
                        }
                        $record->delete();
    ...
    {
        return [
            'index' => Pages\ListKategoriAlatKerjas::route('/'),
        ];
    }
}
