...
class ListKategoriPestisidas extends ListRecords
{
    protected static string $resource = KategoriPestisidaResource::class;

    protected static ?string $breadcrumb = "Daftar Kategori Pestisida";
    ...
    protected function getHeaderActions(): array
    {
        return [
             CreateAction::make()
                ...
                ->modalHeading('Tambah Kategori Pestisida Baru')
                ->form([
