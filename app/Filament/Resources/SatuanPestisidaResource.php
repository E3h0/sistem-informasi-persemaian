...
use App\Filament\Resources\SatuanPestisidaResource\Pages;
use App\Filament\Resources\SatuanPestisidaResource\RelationManagers;

class SatuanPestisidaResource extends Resource
{
    protected static ?string $model = SatuanPestisida::class;

    protected static ?string $modelLabel = "Satuan Pestisdia";
    protected static ?string $pluralModelLabel = "Satuan Pestisida";
    protected static ?string $slug = "satuan-pestisida";
    protected static ?string $breadcrumb = "Satuan Pestisida";
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\EditAction::make()
                    ->modalHeading('Edit Data Satuan Pestisida')
                    ->form([
                    ...
                    ->action(function ($record){
                        if ($record->pestisida()->count() > 0) {
                            Notification::make()
                                ...
                                ->body('Satuan pestisida ini sedang digunakan di data pestisida')
                                ->send();
                            return;
                        }
                        $record->delete();
    ...
    {
        return [
            'index' => Pages\ListSatuanPestisidas::route('/'),
        ];
    }
}
